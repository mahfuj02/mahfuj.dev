            ...
            <div className="mt-6 flex flex-wrap gap-3">
              {project.liveUrl ? (
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-teal-500/10 border border-teal-500/30 px-5 py-2 text-sm font-semibold text-teal-300 transition-colors hover:bg-teal-500/20"
                >
              ...
              {project.githubUrl ? (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-full border border-zinc-700 px-5 py-2 text-sm font-semibold text-zinc-300 transition-colors hover:border-zinc-500 hover:text-zinc-100"
                >
                  GitHub →
                </a>
              ) : null}
